...
A dataset containing student scores is used for training the model.
The system determines the weakest subject for each student based on their marks.
A Decision Tree classification model is trained using this dataset.
When a user enters their scores, the model predicts the subject that should receive more focus.
Technologies Used
...
Author
Aditya Chouksey CSE (AI & ML) – First Year Course: Fundamentals of AI and ML
